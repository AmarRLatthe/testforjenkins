			...
			<div class="col-sm-6">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="disable.do">Disable</a></li>
					</ul>
					<h5>${ userLoggedIn }</h5>
				</div>
			</div>
				...
				<form class="form-horizontal" role="form" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="phoneNumber" name="phoneNumber"
								value="${dto.phoneNumber}" class="form-control" disabled>
							<!--  <span
					...
					<div class="form-group">
						<label for="birthDate" class="col-sm-3 control-label">Date
							of Birth*</label>
						<div class="col-sm-9">
							<input type="date" name="birthDate" value="${dto.birthDate}" class="form-control">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" value="${dto.experience}"
